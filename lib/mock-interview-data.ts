...
const interviewTypes: MockInterviewType[] = [
  {
    ...
    description: "Practice frontend development interview questions focusing on React, JavaScript, and CSS.",
    icon: "💻",
  ...
  },
  {
    ...
    description: "Practice backend development interview questions focusing on Node.js, databases, and API design.",
    icon: "🖥️",
    difficulty: "Advanced",
    duration: "60",
    topics: ["Node.js", "Databases", "API Design", "System Design", "Performance"],
  },
  {
    id: "fullstack",
    title: "Full Stack Developer",
    description: "Comprehensive interview covering both frontend and backend topics with system design questions.",
    icon: "🔄",
    difficulty: "Advanced",
    duration: "90",
  ...
  },
  {
    ...
    description: "Practice DevOps interview questions focusing on CI/CD, containerization, and cloud services.",
    icon: "🚀",
    difficulty: "Advanced",
    duration: "60",
      ...
      questionAnalysis: [
        {
          ...
          userAnswer: "Your answer demonstrated good understanding of JavaScript variable declarations...",
          feedback:
        ...
        },
        {
          ...
          userAnswer: "Your answer covered key optimization techniques including memoization...",
          feedback:
      ...
      recommendations: [
        {
          ...
          description: "Learn advanced React patterns to improve your component architecture",
          resources: ["React Patterns Course", "Component Design Best Practices"],
        },
        {
          title: "System Design for Frontend Engineers",
          description: "Improve your system design skills for frontend applications",
          resources: ["Frontend System Design", "Scalable Frontend Architecture"],
        },
      ],
    },
  },
...
const interviewQuestions: InterviewQuestion[] = [
  ...
  {
    id: "q3",
    question: "Design a REST API for a social media platform with posts, comments, and likes.",
    type: "System Design",
    difficulty: "Advanced",
    timeLimit: 20,
  },
...
export function getInterviewTypeById(id: string): MockInterviewType | undefined {
