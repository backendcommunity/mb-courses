...
export default function Dashboard() {
  ...
  const renderContent = () => {
    ...
    if (
      currentPath.startsWith("/dashboard/courses/") &&
      currentPath.endsWith("/certificate")
    ) {
      const courseId = currentPath.split("/")[3];
      return (
    ...
    if (
      currentPath.startsWith("/dashboard/paths/") &&
      currentPath.endsWith("/continue")
    ) {
    ...
    if (
      currentPath.startsWith("/dashboard/bootcamps/") &&
    ...
    if (
      currentPath.startsWith("/dashboard/project30/") &&
    ...
    if (
      currentPath.startsWith("/dashboard/project30/") &&
      currentPath.endsWith("/leaderboard")
    ) {
      const courseId = currentPath.split("/")[3];
      return (
    ...
    if (
      currentPath.startsWith("/dashboard/interviews/") &&
      currentPath.endsWith("/project")
    ) {
    ...
    if (
      currentPath.startsWith("/dashboard/interviews/") &&
      currentPath.endsWith("/algorithm")
    ) {
      const interviewId = currentPath.split("/")[3];
      return (
    ...
    if (
      currentPath.startsWith("/dashboard/mock-interviews/") &&
      currentPath.endsWith("/results")
    ) {
