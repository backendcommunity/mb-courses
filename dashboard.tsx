...
//     // MB Store
//     if (pathname === "/xp-store") {
//       return <XpRedemptionPage onNavigate={handleNavigate} />;
//     }

//     // Courses
//     if (pathname === routes.courses) {
//       return <CoursesPage onFilter={() => {}} onNavigate={handleNavigate} />;
//     }

//     if (pathname.startsWith("/courses/") && pathname.includes("/preview")) {
//       const courseId = pathname.split("/")[3];
//       return <CoursePreviewPage slug={courseId} onNavigate={handleNavigate} />;
//     }
...
//     if (pathname.startsWith("/courses/") && pathname.endsWith("/quizzes")) {
//       const courseId = pathname.split("/")[3];
//       return <CourseQuizzesPage slug={courseId} onNavigate={handleNavigate} />;
//     }
...
//     if (pathname.startsWith("/courses/") && pathname.endsWith("/exercises")) {
//       const courseId = pathname.split("/")[3];
//       return (
...
//     if (pathname.startsWith("/courses/") && pathname.endsWith("/playgrounds")) {
//       const courseId = pathname.split("/")[3];
//       return (
...
//     if (pathname.startsWith("/courses/") && pathname.endsWith("/projects")) {
//       const courseId = pathname.split("/")[3];
//       return (
...
//     if (pathname.startsWith("/courses/") && pathname.endsWith("/certificate")) {
//       const courseId = pathname.split("/")[3];
//       return (
//         <CourseCertificatePage slug={courseId} onNavigate={handleNavigate} />
//       );
//     }

//     if (pathname.startsWith("/courses/") && pathname.split("/").length === 4) {
//       const courseId = pathname.split("/")[3];
//       return <CourseDetailPage slug={courseId} onNavigate={handleNavigate} />;
//     }
...
//     if (pathname.startsWith("/roadmaps/") && pathname.endsWith("/watch")) {
...
//     if (pathname.startsWith("/roadmaps/") && pathname.includes("/video/")) {
//       const parts = pathname.split("/");
...
//     if (pathname.startsWith("/roadmaps/") && pathname.split("/").length === 4) {
//       const roadmapId = pathname.split("/")[3];
//       return (
...
//     if (pathname.startsWith("/paths/") && pathname.endsWith("/continue")) {
...
//     if (pathname.startsWith("/paths/") && pathname.includes("/watch/")) {
//       const parts = pathname.split("/");
...
//     if (pathname.startsWith("/paths/") && pathname.split("/").length === 4) {
//       const pathId = pathname.split("/")[3];
//       return (
...
//     if (pathname.startsWith("/bootcamps/") && pathname.endsWith("")) {
...
//     if (pathname.startsWith("/bootcamps/") && pathname.includes("/week/")) {
//       const parts = pathname.split("/");
...
//     if (pathname.startsWith("/project30/") && pathname.includes("/day/")) {
//       const parts = pathname.split("/");
//       const courseId = parts[3];
...
//     if (pathname.startsWith("/project30/") && pathname.endsWith("/community")) {
//       const courseId = pathname.split("/")[3];
//       return (
...
//     if (pathname.startsWith("/projects/") && pathname.split("/").length === 4) {
...
//     if (pathname.startsWith("/lands/") && pathname.split("/").length === 4) {
...
//     if (pathname.startsWith("/interviews/") && pathname.endsWith("/project")) {
...
//     if (pathname.startsWith("/interviews/") && pathname.endsWith("/results")) {
//       const interviewId = pathname.split("/")[3];
//       return (
