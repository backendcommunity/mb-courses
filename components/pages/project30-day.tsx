...
export function Project30DayPage({ dayNumber, onNavigate }: Project30DayPageProps) {
...
server.listen(PORT, () => {
  ...
  const projectData = {
    ...
    description: "Learn how to build a WebSocket-based chat API with rooms and user presence tracking",
    ...
    <div className="flex-1 space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="sm" onClick={() => onNavigate("/dashboard/project30")}>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="text-2xl font-bold mt-1">{projectData.estimatedTime}</p>
          </CardContent>
        </Card>
            ...
            <TabsContent value="video">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Watch the step-by-step tutorial to build this project</CardDescription>
                </CardHeader>
                        ...
                        <div className="flex items-center gap-3">
                          <div className="flex items-center gap-2">
                            ...
                            <div className="w-16 bg-gray-600 h-1 rounded-full overflow-hidden">
                              <div className="bg-white h-full" style={{ width: `${volume}%` }}></div>
                            </div>
                          </div>
                          <Button variant="ghost" size="icon" className="h-8 w-8 text-white">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3 p-2 rounded-md bg-[#F2C94C]/10 border border-[#F2C94C]/20">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-muted-foreground">00:00 - 02:45</p>
                        </div>
                      ...
                      <div className="flex items-center gap-3 p-2 rounded-md hover:bg-muted/50">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium">Setting Up the Express Server</p>
                          <p className="text-xs text-muted-foreground">02:46 - 08:30</p>
                        </div>
                        <Button variant="ghost" size="sm" className="h-8 w-8 p-0">
                          <Play className="h-4 w-4" />
                        </Button>
                      ...
                      <div className="flex items-center gap-3 p-2 rounded-md hover:bg-muted/50">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium">Integrating Socket.io</p>
                          <p className="text-xs text-muted-foreground">08:31 - 15:20</p>
                        </div>
                        <Button variant="ghost" size="sm" className="h-8 w-8 p-0">
                          <Play className="h-4 w-4" />
                        </Button>
                      ...
                      <div className="flex items-center gap-3 p-2 rounded-md hover:bg-muted/50">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium">Implementing Chat Rooms</p>
                          <p className="text-xs text-muted-foreground">15:21 - 22:15</p>
                        </div>
                        <Button variant="ghost" size="sm" className="h-8 w-8 p-0">
                          <Play className="h-4 w-4" />
                        </Button>
                      ...
                      <div className="flex items-center gap-3 p-2 rounded-md hover:bg-muted/50">
                        <div className="flex h-6 w-6 items-center justify-center rounded-full bg-muted text-xs">5</div>
                        <div className="flex-1">
                          <p className="text-sm font-medium">Redis Integration</p>
                          <p className="text-xs text-muted-foreground">22:16 - 28:45</p>
                        </div>
                        <Button variant="ghost" size="sm" className="h-8 w-8 p-0">
                          <Play className="h-4 w-4" />
                        </Button>
                      ...
                      <div className="flex items-center gap-3 p-2 rounded-md hover:bg-muted/50">
                        <div className="flex h-6 w-6 items-center justify-center rounded-full bg-muted text-xs">6</div>
                        <div className="flex-1">
                          <p className="text-sm font-medium">Testing and Conclusion</p>
                          <p className="text-xs text-muted-foreground">28:46 - 32:00</p>
                        </div>
                        <Button variant="ghost" size="sm" className="h-8 w-8 p-0">
                          <Play className="h-4 w-4" />
                        </Button>
            ...
            <TabsContent value="code">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Follow along with the video and write your code here</CardDescription>
                </CardHeader>
            ...
            <TabsContent value="submit">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Share your completed project to earn XP and maintain your streak</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      <Label htmlFor="submission-url">Project URL (GitHub, CodePen, etc.)</Label>
                      <div className="flex items-center gap-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Link to your project on CodeSandbox, GitHub, or any other platform
                      </p>
                    </div>
                    <div className="space-y-2">
        ...
        <div className="lg:col-span-1">
            ...
            <TabsContent value="requirements">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Complete these tasks after watching the video</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
            ...
            <TabsContent value="resources">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Additional materials to help you complete the project</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
            ...
            <TabsContent value="hints">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Tips to help you if you get stuck</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
          ...
          <Card className="mt-4">
            <CardHeader>
              ...
              <CardDescription>Make sure your project meets these requirements</CardDescription>
            </CardHeader>
            <CardContent>
