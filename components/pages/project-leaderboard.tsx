...
export function ProjectLeaderboardPage({
  ...
  const loadWeekly = async () => {
    ...
    setWeeklyLeaderboards(data.leaderboardUsers);
  ...
  const loadAchievements = async () => {
    const data = await store.getProjectAchievements(slug);
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Project Leaderboard</h1>
              ...
              {topUsers?.[1] && (
                <CardContent className="text-center pt-0">
                  ...
                  <div className="mt-2 text-sm text-muted-foreground">
                    <div>Tasks: {topUsers?.[1]?.projects}</div>
            ...
            <Card className="border-2 border-amber-400 -mt-4">
              ...
              {topUsers?.[0] && (
                <CardContent className="text-center pt-0">
                  ...
                  <div className="mt-2 text-sm text-muted-foreground">
                    <div>Tasks: {topUsers?.[0]?.projects}</div>
            ...
            <Card className="border-2 border-amber-700">
              ...
              {topUsers?.[2] && (
                <CardContent className="text-center pt-0">
                  ...
                  <div className="mt-2 text-sm text-muted-foreground">
                    <div>Tasks: {topUsers?.[2]?.projects}</div>
              ...
              {leaderboards.length >= 1 && (
                <div className="space-y-4">
                  ...
                  <div className="rounded-md border">
                    ...
                    {currentUser && !isTop10(currentUser?.id!) && (
                      <>
