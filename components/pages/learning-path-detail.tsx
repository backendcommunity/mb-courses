...
import { ArrowLeft, Clock, BookOpen, Code2, Target, CheckCircle2, Users, Star, Play } from "lucide-react"
...
export function LearningPathDetailPage({ pathId, onNavigate }: LearningPathDetailPageProps) {
    ...
    return (
      <div className="flex-1 p-6">
        <div className="text-center">
          ...
          <Button onClick={() => onNavigate?.("/dashboard/paths")} className="mt-4">
  ...
  return (
    <div className="flex-1 space-y-6 p-6">
      ...
      <div className="flex items-center gap-4">
        <Button variant="ghost" onClick={() => onNavigate?.("/dashboard/paths")}>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-4 md:grid-cols-3">
                    <div className="space-y-2">
                      ...
                      <span className="text-xs text-blue-100">2 of {path.courses.length} completed</span>
                    </div>
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-blue-100">1 of {path.projects.length} completed</span>
                    </div>
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-blue-100">1 of 4 completed</span>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <Tabs defaultValue="overview" className="w-full">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <div className="text-center p-4 border rounded-lg">
                      <div className="text-2xl font-bold text-green-600">{path.projects.length}</div>
                      <div className="text-sm text-muted-foreground">Projects</div>
                    </div>
                    <div className="text-center p-4 border rounded-lg">
                      <div className="text-2xl font-bold text-purple-600">{path.estimatedTime}</div>
            ...
            <TabsContent value="curriculum" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Core courses in this learning path</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                        ...
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Button
                              size="sm"
                              variant="ghost"
                              onClick={() => onNavigate?.(`/dashboard/courses/${course.id}`)}
                            >
            ...
            <TabsContent value="projects" className="space-y-4">
              <Card>
                <CardHeader>
                  <CardTitle>Hands-on Projects ({path.projects.length})</CardTitle>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <Badge variant={path.level === "Advanced" ? "destructive" : "default"}>{path.level}</Badge>
            ...
            <CardContent className="space-y-4">
              {path.enrolled ? (
                <div className="space-y-3">
                  ...
                  <Button className="w-full" onClick={() => onNavigate?.(`/dashboard/paths/${path.id}/continue`)}>
                    Continue Learning
                  </Button>
                ...
                <div className="space-y-3">
                  <Button className="w-full" onClick={() => store.enrollInPath(path.id)}>
                    Start Learning Path
                  </Button>
                  <Button variant="outline" className="w-full">
                    Add to Wishlist
