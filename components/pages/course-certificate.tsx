...
export function CourseCertificatePage({ courseId, onNavigate }: CourseCertificatePageProps) {
    ...
    return (
      <div className="flex-1 space-y-6 p-6">
        ...
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground mb-6">Complete the course to earn your certificate.</p>
