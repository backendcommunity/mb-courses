  ...
  return (
    <div className="p-4 md:p-6 space-y-6 bg-background">
      ...
      <div className="mb-6 md:mb-8">
        ...
        <p className="text-muted-foreground text-sm md:text-base">Continue your backend mastery journey</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-6 md:mb-8">
        <Card className="border-border bg-card">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-xs md:text-sm font-medium">XP Points</CardTitle>
        ...
        <Card className="border-border bg-card">
          ...
          <CardContent>
            <div className="text-lg md:text-2xl font-bold text-primary">15 days</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <h4 className="font-medium text-sm md:text-base">Node.js Advanced Concepts</h4>
                <Badge variant="secondary" className="bg-primary/10 text-primary border-primary/20 text-xs">
                  In Progress
                </Badge>
              </div>
              <Progress value={68} className="h-2" />
              <p className="text-xs md:text-sm text-muted-foreground">Chapter 8: Event Loop Deep Dive</p>
              <Button
                size="sm"
        ...
        <Card className="border-border bg-card">
          <CardHeader>
            ...
            <CardDescription className="text-sm">Your active project</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <h4 className="font-medium text-sm md:text-base">E-commerce API</h4>
                <Badge variant="outline" className="border-accent/30 text-accent text-xs">
                  Day 12/30
                </Badge>
              </div>
              <Progress value={40} className="h-2" />
              <p className="text-xs md:text-sm text-muted-foreground">Building authentication system</p>
              <Button
                size="sm"
                variant="outline"
      ...
      <Card className="border-border bg-card">
        <CardHeader>
          ...
          <CardDescription className="text-sm">Jump into your learning journey</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="space-y-3 md:space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs md:text-sm">Completed quiz: "Database Indexing Strategies"</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs md:text-sm">Started new course: "Microservices Architecture"</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs md:text-sm">Deployed project: "Real-time Chat App"</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
            <div className="flex items-center gap-3 p-3 bg-yellow-500/5 border border-yellow-500/20 rounded-lg">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs md:text-sm text-muted-foreground">Complete 10 coding challenges</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-primary/5 border border-primary/20 rounded-lg">
              <BookOpen className="h-6 w-6 md:h-8 md:w-8 text-primary flex-shrink-0" />
              <div className="min-w-0">
                <p className="font-medium text-sm md:text-base">Knowledge Seeker</p>
                <p className="text-xs md:text-sm text-muted-foreground">Complete 5 courses</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-green-500/5 border border-green-500/20 rounded-lg">
              ...
              <div className="min-w-0">
                <p className="font-medium text-sm md:text-base">Community Helper</p>
                <p className="text-xs md:text-sm text-muted-foreground">Help 10 community members</p>
              </div>
            </div>
          </div>
        </CardContent>
