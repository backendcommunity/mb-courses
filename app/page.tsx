      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            <Badge
              variant="outline"
              className="mb-4 bg-[#13AECE]/10 text-[#13AECE] border-[#13AECE]/20"
            >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Learn, Build, and Grow your backend development skills through our
              comprehensive 3-step transformation process. From beginner to
              senior engineer.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-[#13AECE] hover:bg-[#13AECE]/90"
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Our proven 3-step transformation process takes you from beginner
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center">
              <CardHeader>
                ...
                <CardDescription>
                  Master fundamentals through courses, bootcamps, and learning
                  paths
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="text-center">
              <CardHeader>
                ...
                <CardDescription>
                  Apply knowledge through real-world projects and challenges
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="text-sm text-muted-foreground space-y-2">
            ...
            <Card className="text-center">
              <CardHeader>
                ...
                <CardDescription>
                  Advance your career with interviews, certifications, and
                  community
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                      ...
                      <p className="text-muted-foreground mb-6">
                        Learn from industry experts through structured, hands-on
                        courses covering everything from basics to advanced
                        topics.
                      </p>
                ...
                <CardContent className="p-8">
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                      ...
                      <p className="text-muted-foreground mb-6">
                        Build production-ready applications that showcase your
                        skills and enhance your portfolio.
                      </p>
                      <ul className="space-y-3">
                        <li className="flex items-center">
                    ...
                    <div className="bg-muted rounded-lg p-6">
                      <div className="space-y-4">
                        ...
                        <div className="p-4 bg-background rounded-lg">
                          ...
                          <p className="text-sm text-muted-foreground mb-3">
                            Create a scalable chat application with WebSocket
                ...
                <CardContent className="p-8">
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                      ...
                      <p className="text-muted-foreground mb-6">
                        Connect with fellow developers, get help, share
                        knowledge, and grow together in our supportive
                        community.
                      </p>
                      <ul className="space-y-3">
                        <li className="flex items-center">
              ...
              <Card>
                <CardContent className="p-8">
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                      <h3 className="text-2xl font-bold mb-4">
                        MB Lands - Gamified Learning
                      </h3>
                      <p className="text-muted-foreground mb-6">
                        Make learning fun and engaging with our gamified
                        platform featuring MB, levels, achievements, and
                        challenges.
                      </p>
                      <ul className="space-y-3">
                        <li className="flex items-center">
                          <Trophy className="h-5 w-5 text-[#F2C94C] mr-3" />
                          <span>Earn MB and level up your skills</span>
                        </li>
                        <li className="flex items-center">
                          <Trophy className="h-5 w-5 text-[#F2C94C] mr-3" />
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Transform your backend development skills through comprehensive
